...
A curated collection of frontend projects and JavaScript exercises demonstrating progressive skill development — from foundational CSS animations to interactive JavaScript applications and modern React components.
...
│
├── 1. CSS Mini Projects/
│   ├── Button_anime/              # Animated button effects
│   ├── Hamburger Menu/            # Responsive hamburger navigation
│   ├── Loading Animation/         # Custom CSS loading spinners
│   └── Login Pages/               # Stylized login UIs (Animated, Liquid Drop)
│
├── 2. JS Practice/
│   ├── Day01/ ... Day50/          # 50 days of JavaScript exercises
│
├── 3. Frontend Projects Using JS/
│   ├── Kanban Board ToDo App/     # Drag-and-drop task management board
│   └── Snake Game/                # Classic snake game implementation
│
├── 4. Frontend Project Using React/
│   └── OTP Input With Auto-Focus/ # OTP input component with smart auto-focus
│
└── README.md
```
...
- **Progressive Learning:** A structured approach from CSS fundamentals → JavaScript mastery → React + TypeScript.
- **Clean Code Practices:** Readable, well-organized codebases with consistent formatting (Prettier, ESLint).
- **Real-World Problem Solving:** Projects like the Kanban Board and OTP Input tackle practical UI/UX challenges.
- **Modern Tooling Proficiency:** Hands-on experience with Vite, TypeScript, Tailwind CSS v4, and React 19.
...
<p align="center">
  Built with 💻 and ☕ by <strong>Madhur Purohit</strong>
</p>
